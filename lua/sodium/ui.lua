...
return lush(function()
  return {
    ...
    DiagnosticVirtualLinesError({ DiagnosticFloatingError }),
    DiagnosticVirtualLinesWarn({ DiagnosticFloatingWarn }),
    DiagnosticVirtualLinesInfo({ DiagnosticFloatingInfo }),
    DiagnosticVirtualLinesHint({ DiagnosticFloatingHint }),
