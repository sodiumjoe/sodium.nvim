...
Method = {fg = "#7FC1CA"},
MiniIconsAzure = {fg = "#7399C8"},
MiniIconsBlue = {fg = "#83AFE5"},
MiniIconsCyan = {fg = "#7FC1CA"},
MiniIconsGreen = {fg = "#A8CE93"},
MiniIconsGrey = {fg = "#899BA6"},
MiniIconsOrange = {fg = "#F2C38F"},
MiniIconsPurple = {fg = "#d5508f"},
MiniIconsRed = {fg = "#DF8C8C"},
MiniIconsYellow = {fg = "#DADA93"},
ModeMsg = {fg = "#DADA93"},
MoreMsg = {fg = "#3C4C55"},
MsgArea = {},
NonText = {fg = "#556873"},
...
-- require("lush")(require("sodium-colors"))
